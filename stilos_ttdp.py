...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_ttdp.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Clasificaci\xc3\xb3n por textura</sld:Name>\n")
file.write("                    <sld:Title>Clasificaci\xc3\xb3n por textura</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['TTDP_1','fill'])
for i in capa:
      if i[0]=="NO APLICA":
       file.write("\n")
       file.write("\n")
