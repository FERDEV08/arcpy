...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_ca.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Categor\xc3\xadas de capacidad de acogida</sld:Name>\n")
file.write("                    <sld:Title>Categor\xc3\xadas de capacidad de acogida</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['CA_1','fill'])
for i in capa:
      file.write("                </sld:Rule>\n")
      file.write("                <sld:Rule>\n")
      ...
      file.write("                            <ogc:PropertyName>ca</ogc:PropertyName>\n")
