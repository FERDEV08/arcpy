...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_dis.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Clasificaci\xc3\xb3n por disponibilidad de servicios b\xc3\xa1sicos</sld:Name>\n")
file.write("                    <sld:Title>Clasificaci\xc3\xb3n por disponibilidad de servicios b\xc3\xa1sicos</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['DIS_1','fill'])
for i in capa:
      file.write("                </sld:Rule>\n")
      file.write("                <sld:Rule>\n")
      ...
      file.write("                            <ogc:PropertyName>dis</ogc:PropertyName>\n")
