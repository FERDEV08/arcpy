...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_cuc.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Categor\xc3\xadas de conflictos de uso para zonas consolidadas</sld:Name>\n")
file.write("                    <sld:Title>Categor\xc3\xadas de conflictos de uso para zonas consolidadas</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['CUC_1','fill'])
for i in capa:
   if i[0] =="NO APLICA":
       ...
       file.write("                            <ogc:PropertyName>cuc</ogc:PropertyName>\n")
