...
for i in j:
    ...
    arcpy.Append_management(LAYER,arcpy.os.path.join(BN,"GEOMORFOLOGIA","U_GEOM_CIUDAD_A"),"NO_TEST")
    arcpy.RecalculateFeatureClassExtent_management(arcpy.os.path.join(BN,"GEOMORFOLOGIA","U_GEOM_CIUDAD_A"))
    ...
    nw = arcpy.os.path.join(BN,"GEOMORFOLOGIA","U_GEOM_"+nom(i[0])+"_A")
    an = arcpy.os.path.join(BN,"GEOMORFOLOGIA","U_GEOM_CIUDAD_A")
