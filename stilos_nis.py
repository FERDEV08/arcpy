...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_nis.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Clasificaci\xc3\xb3n por nivel de instrucci\xc3\xb3n</sld:Name>\n")
file.write("                    <sld:Title>Clasificaci\xc3\xb3n por nivel de instrucci\xc3\xb3n</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['NIS','fill'])
for i in capa:
      file.write("                </sld:Rule>\n")
      file.write("                <sld:Rule>\n")
