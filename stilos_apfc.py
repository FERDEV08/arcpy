...
def nom_ugesp(abrev):
 if abrev == "BAHIA DE CARAQUEZ":
  ...
  return abrev
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_apfc.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Categor\xc3\xadas de aptitud f\xc3\xadsica constructiva</sld:Name>\n")
file.write("                    <sld:Title>Categor\xc3\xadas de aptitud f\xc3\xadsica constructiva</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['apfc','fill'])
for i in capa:
      file.write("                </sld:Rule>\n")
      file.write("                <sld:Rule>\n")
      ...
      file.write("                            <ogc:PropertyName>apfc</ogc:PropertyName>\n")
