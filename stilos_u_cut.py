...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_cut.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Clases de capacidad de uso de la tierra</sld:Name>\n")
file.write("                    <sld:Title>Clases de capacidad de uso de la tierra</sld:Title>\n")
...
capa=arcpy.da.SearchCursor(capa,['CAG_1','Titulo','fill'])
for i in capa:
      if i[0]=="NO APLICA":
       file.write("               </sld:Rule>\n")
       file.write("               <sld:Rule>\n")
       file.write("                    <sld:Name>NO APLICA</sld:Name>\n")
       file.write("                    <sld:Title>NO APLICA</sld:Title>\n")
       file.write("                    <ogc:Filter>\n")
       file.write("                        <ogc:PropertyIsEqualTo>\n")
       file.write("                            <ogc:PropertyName>cag</ogc:PropertyName>\n")
       file.write("                            <ogc:Literal>NO APLICA</ogc:Literal>\n")
       file.write("                        </ogc:PropertyIsEqualTo>\n")
       file.write("                    </ogc:Filter>\n")
       ...
       file.write("                                        <sld:OnlineResource xmlns:xlink='http://www.w3.org/1999/xlink' xlink:href='file:/srv/clima/NO APLICABLE.png'/>\n")
       file.write("                                        <sld:Format>image/png</sld:Format>\n")
       file.write("                                    </sld:ExternalGraphic>\n")
       file.write("                                </sld:Graphic>\n")
       file.write("                            </sld:GraphicFill>\n")
       file.write("                        </sld:Fill>\n")
       file.write("                        <sld:Stroke>\n")
       file.write("                            <sld:CssParameter name='stroke'>#d4d0c8</sld:CssParameter>\n")
       file.write("                            <sld:CssParameter name='stroke-width'>0.4</sld:CssParameter>\n")
       file.write("                        </sld:Stroke>\n")
       file.write("                    </sld:PolygonSymbolizer>\n")
       file.write("					<sld:LineSymbolizer>\n")
       file.write("                        <sld:Stroke>\n")
       file.write("                            <sld:CssParameter name='stroke'>#686868</sld:CssParameter>\n")
       file.write("                            <sld:CssParameter name='stroke-width'>0.4</sld:CssParameter>\n")
       file.write("                        </sld:Stroke>\n")
       file.write("                    </sld:LineSymbolizer>\n")
       ...
       file.write("                </sld:Rule>\n")
       file.write("                <sld:Rule>\n")
       file.write("                    <sld:Name>"+i[1].encode('UTF-8')+"</sld:Name>\n")
       file.write("                    <sld:Title>"+i[1].encode('UTF-8')+"</sld:Title>\n")
       file.write("                    <ogc:Filter>\n")
       file.write("                        <ogc:PropertyIsEqualTo>\n")
       file.write("                            <ogc:PropertyName>cag</ogc:PropertyName>\n")
