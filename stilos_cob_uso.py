...
path1= arcpy.os.path.join(carpeta,"stl_"+nom_ugesp(ciudad).lower()+"_cob_uso.sld")
file = open(path1, "w")
...
file.write("                <sld:Rule>\n")
file.write("                    <sld:Name>Clasificado por la cobertura</sld:Name>\n")
file.write("                    <sld:Title>Clasificado por la cobertura</sld:Title>\n")
...
for i in capa:
      file.write("                </sld:Rule>\n")
      file.write("                <sld:Rule>\n")
      arcpy.AddMessage(i.getValue("CBT_1"))
      file.write("                    <sld:Name>"+i.getValue("CBT_1").encode("UTF-8")+"</sld:Name>\n")
      file.write("                    <sld:Title>"+i.getValue("CBT_1").encode("UTF-8")+"</sld:Title>\n")
      file.write("                    <ogc:Filter>\n")
      file.write("                        <ogc:PropertyIsEqualTo>\n")
      file.write("                            <ogc:PropertyName>cbt</ogc:PropertyName>\n")
      file.write("                            <ogc:Literal>"+i.getValue("CBT_1").encode("UTF-8")+"</ogc:Literal>\n")
      file.write("                        </ogc:PropertyIsEqualTo>\n")
      file.write("                    </ogc:Filter>\n")
      file.write("                    <sld:MaxScaleDenominator>4500000</sld:MaxScaleDenominator>\n")
      file.write("                    <sld:PolygonSymbolizer>\n")
      file.write("                        <sld:Fill>\n")
      file.write("                            <sld:GraphicFill>\n")
      file.write("                                <sld:Graphic>\n")
      file.write("                                    <sld:ExternalGraphic>\n")
      file.write(i.getValue("SIMBOLOGIA").encode("UTF-8"))
      file.write("                                        <sld:Format>image/png</sld:Format>\n")
      file.write("                                    </sld:ExternalGraphic>\n")
      file.write("                                    <sld:Opacity>\n")
      file.write("                                        <ogc:Literal>0.8</ogc:Literal>\n")
      file.write("                                    </sld:Opacity>\n")
      file.write("                                    <sld:Size>\n")
      file.write("                                        <ogc:Literal>60.0</ogc:Literal>\n")
      file.write("                                    </sld:Size>\n")
      file.write("                                    <sld:Rotation>\n")
      file.write("                                        <ogc:Literal>0.0</ogc:Literal>\n")
      file.write("                                    </sld:Rotation>\n")
      file.write("                                </sld:Graphic>\n")
      file.write("                            </sld:GraphicFill>\n")
      file.write("                            <sld:CssParameter name='fill'>\n")
      file.write(i.getValue("OGC"))
      file.write("                            </sld:CssParameter>\n")
      file.write("                            <sld:CssParameter name='fill-opacity'>\n")
      file.write("                                <ogc:Literal>0.8</ogc:Literal>\n")
      file.write("                            </sld:CssParameter>\n")
      file.write("                        </sld:Fill>\n")
      file.write("                    </sld:PolygonSymbolizer>\n")
